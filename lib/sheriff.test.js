...
describe('WIP API', () => {
    ...
    it('refuse with default pattern', () => {
        const result = sheriff.wip('WIP: ok / nok');
        expect(result).toEqual({
            isSuccess: false,
    ...
    it('refuse with specified pattern', () => {
        const result = sheriff.wip('ok :WIP', '* :WIP');
        expect(result).toEqual({
            isSuccess: false,
            description: 'That pull request is still in work in progress',
            bypass: false,
    ...
    it('valid with default pattern', () => {
        const result = sheriff.wip('ok');
        expect(result).toEqual({
            isSuccess: true,
    ...
    it('valid with default pattern and no title', () => {
        const result = sheriff.wip();
        expect(result).toEqual({
            isSuccess: true,
            description: 'That pull request is ready to go',
            bypass: false,
    ...
    it('valid with specified pattern', () => {
        const result = sheriff.wip('WIP: not ok', '* :WIP');
        expect(result).toEqual({
            isSuccess: true,
            description: 'That pull request is ready to go',
            bypass: false,
